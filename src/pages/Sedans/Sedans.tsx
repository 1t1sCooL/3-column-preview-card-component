    ...
    return (
        <div className="sedans">
            <svg width="64" height="40"
                ...
                fill="#000" opacity=".201" cx="20" cy="20" r="20"/><path
            ...
            <h2 className="header">Sedans</h2>
            <p className="desc">Choose a sedan for its affordability and excellent fuel economy. Ideal for cruising in the city
